...
\documentclass[a4paper]{deedy-resume} % Use US Letter paper, change to a4paper for A4 
    ...
    \iftrue
    \runsubsection{Gravity Vault Radnor}
    \descript{| climbing instructor}
    \location{August 2019 - Present | Radnor, Pensylvania}

    \begin{description}
        \item[Climbing Instructor] responsible for working with customers at all levels of rock climbing ability
        \item[Youth Summer Camp Counselor] responsible for teaching climbing and safety during summer of 2020
    \end{description}
    \fi
    ...
    \iftrue
    \runsubsection{Experimental Print Making Institute}
    \descript{| laser cutter technician \epsamp{} studio assistant}
    \location{September 2019 - January 2020 | Easton, Pensylvania}

    \begin{description}
        \item[Laser Cutter Technician] in charge of maintaining, testing, and incorporating a laser cutter into the printmaking process
        \item[Studio Assistant] generally available for work in the studio of any variety
    \end{description}
    \fi
    ...
    \iffalse
    \runsubsection{The LEGO Group}
    \descript{| master builder finalist}
    \location{January 2019 | San Antonio, Texas}

    \begin{description}
        \item[Competitor] in LEGO building competition, made it to final round of 10 from a field of ~40
    \end{description}
    \fi
    ...
    \iftrue
    \runsubsection{Lafayette College ITS}
    \descript{| help desk}
    \location{2015 - 2018 | Easton, Pennsylvania}
    ...
    \begin{minipage}{0.24\textwidth}
        \subsection{Art \epsamp{} Fabrication}
        ...
        \location{SCULPTURE}
            \textbullet{} Silicon \epsamp{} plaster casting\\
    ...
    \begin{minipage}{0.24\textwidth}
        ...
        \location{ROCK CLIMBING}
            \textbullet{} lead 5.10, top rope 5.11c \\
